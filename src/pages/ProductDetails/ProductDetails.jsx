...
import { Breadcrumbs, Chip, LinearProgress } from '@mui/material';
...
import UserAvtarImg from '../../components/UserAvatarImg/UserAvtarImg';
                            ...
                            <div className='reviewsRow'>
                                <div className='row'>
                                    <div className='col-sm-7 d-flex'>
                                        <div className='d-flex flex-column'>
                                            <div className='userInfo d-flex align-items-center mb-3'>
                                                <UserAvtarImg img={userImg} lg={true} />
                                    ...
                                    <div className='col-md-5 d-flex align-items-center'>
                                        <div className='ml-auto' style={{ alignSelf: 'baseline' }}>
